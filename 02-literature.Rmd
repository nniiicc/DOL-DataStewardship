# Data Stewarship - Fundamental Concepts 
...
Some examples of metadata catalogues include:
- The Research Data Allliance’s Metadata Standards Catalogue https://rd-alliance.github.io/metadata-directory/
...
1. Variable labels - this provides the name of the variable as it appears in the dataset that a client or stakeholder will download 
2. Variable definitions - this explains what the variable is meant to record or measure. The definition should use plain language - informing the client what the data is meant to represent. Often times this is hard to determine - so if you are creating a new data dictionary you may have to guess what exactly the variable means. 
3. Variable value types - this can typically be a description such as date, a number (or integer) or a text string. The point of defining a variable value is to tell a potential user what type of data they should expect to see in a dataset. 
4. Allowed Values (this could include the Type of value (e.g. string, dateTime) or the Control on that Value (e.g. Postal Codes from the USPS). Value constraints - or allowed values - are extremely important to document because they help a user understand why 05-21-2021 is not just a random assortment of numbers, but in fact follows a standard convention for representing a date (MM-DD-YYYY) 

Data dictionaries can be a little overwhelming to think about initially, but there are a number of valualbe resources to consult when getting started with this form of data documentaiton:
- [Here is an excellent example of a simple data dictionary]( https://missing-pieces.s3.amazonaws.com/missing_pieces_data_dict_11-20-2017.pdf)
- [And a simple introduction to creating data dictionaries](https://help.osf.io/hc/en-us/articles/360019739054-How-to-Make-a-Data-Dictionary)
...
- [This is an excellent introduction to the concept of a codebook](https://www.icpsr.umich.edu/icpsrweb/content/shared/ICPSR/faqs/what-is-a-codebook.html)
- [This is an example of a codebook that follows best practices described in the link above](https://www.icpsr.umich.edu/icpsrweb/instructors/setups/codebook/index.jsp)
...
![](/Users/nmweber/Documents/GitHub/DOL-DataStewardship/images/lifecycle.png)
...
- The DMPTool provides [interactive templates for creating standards compliant DMPs](https://dmptool.org/)
...
- [USGS has an excellent guide on federal agency DMPs](https://www.usgs.gov/products/data-and-tools/data-management/data-management-plans)
...
![](https://raw.githubusercontent.com/nniiicc/DOL-DataStewardship/master/images/precision-recall.png)
...
A [template for a basic data log might look like this simple spreadsheet](https://docs.google.com/spreadsheets/d/1H9WrZEWWmQrOW0Mz_XabhAMqo5xXvRPy7VOTjkMXuDM/edit#gid=0 )
...
https://www.ncsl.org/research/telecommunications-and-information-technology/state-open-data-laws-and-policies.aspx

State Open Data Laws and License Requirements
https://www.ncsl.org/research/telecommunications-and-information-technology/state-open-data-laws-and-policies.aspx 
...
- https://data.wa.gov/Health/Health-Care-Provider-Credential-Data/qxh8-f4bd 

No License

- https://data.wa.gov/Transportation/WA-Tax-Exemptions-Potential-Eligibility-by-Make-Mo/aug9-4a7g 
- https://data.wa.gov/Natural-Resources-Environment/Vehicle-Battery-Registration/we9k-a58y 
